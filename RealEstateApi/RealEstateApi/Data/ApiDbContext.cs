...
namespace RealEstateApi.Data
{
    public class ApiDbContext : DbContext
    {
        ...
        {
            //Server=tcp:sql-online-server.database.windows.net,1433;Initial Catalog=res-database;Persist Security Info=False;User ID=user;Password={your_password};MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;
            //optionsBuilder.UseSqlServer(@"Server=(localdb)\MSSQLLocalDB;Database=ReaEstateDb01;");
            optionsBuilder.UseSqlServer(@"Server=tcp:sql-online-server.database.windows.net,1433;Initial Catalog=res-database;Persist Security Info=False;User ID=user;Password=London@123456;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
        }
